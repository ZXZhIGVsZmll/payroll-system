                ...
                <div class="container-fluid">
                    <div class="panel panel-headline">
                        <div class="panel-heading">
                            ...
                            <p class="panel-subtitle">Employee Information</p>
                        </div>
                        <div class="panel-body">
                            <table id="employeeInformation" class="table table-striped table-hover" style="width:100%">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th>Full Name</th>
    ...
    $(document).ready(function() {
        $('#employeeInformation').DataTable({
            ...
            fnDrawCallback: function() {
                $('#employeeInformation tbody tr').click(function() {
                    var table = $('#employeeInformation').dataTable(),
                        position = table.fnGetPosition(this),
                        id = table.fnGetData(position)[0];
                    document.location.href = 'employee-profile.php?employee-id=' + id;
                })
            }
        });
    });
