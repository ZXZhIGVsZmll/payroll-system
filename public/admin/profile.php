                            ...
                            <div class="profile-left">
                                ...
                                <div class="profile-header">
                                    ...
                                    <div class="profile-main">
                                        <?php
                                        echo "<img src='../avatar/" . $row['img_path'] . "' alt='Avatar' class='img-circle' style='width: 100px; height: 100px;'>"
                                        ?>
                                ...
                                <div class="profile-detail">
                                    ...
                                    <div class="text-center"><a href="edit-profile.php" class="btn btn-primary">Edit Personal & Account Information</a></div>
                                </div>
                                <!-- END PROFILE DETAIL -->
                            </div>
                            <!-- END LEFT COLUMN -->
