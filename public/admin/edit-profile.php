                                ...
                                <div class="profile-left">
                                    <div class="profile-header">
                                        ...
                                        <div class="profile-main">
                                            <div class="img-hover">
                                                <?php echo "<img src='../avatar/" . $row['img_path'] . "' alt='Avatar' id='img' class='img-circle' style='width: 100px; height: 100px;'>";?>
                                                <div class="middle">
                                ...
                                <div class="profile-right">
                                    ...
                                    <div class="profile-detail">
                                        <div class="profile-info">
                                            ...
                                            <a href="edit-employee.php?id=<?php echo $_SESSION['myprofile'];?>">Use this page for editing these fields</a>
                                            </div>
